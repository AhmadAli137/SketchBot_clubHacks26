              ...
              <div className="nav-mobile-header">
                <Link href="/" className="nav-logo" onClick={() => setMobileNavOpen(false)}>
                  <svg width="24" height="24" viewBox="0 0 40 40" fill="none">
                    <rect x="1" y="1" width="38" height="38" rx="10" fill="url(#mb-bg)" stroke="url(#mb-bd)" strokeWidth="0.5"/>
                    <path d="M10 31 C10 22 14 13 20 8" stroke="url(#mb-l)" strokeWidth="2.8" strokeLinecap="round" fill="none"/>
                    <path d="M30 31 C30 22 26 13 20 8" stroke="url(#mb-r)" strokeWidth="2.8" strokeLinecap="round" fill="none"/>
                    <circle cx="20" cy="8" r="3.4" fill="url(#mb-core)"/>
                    <defs>
                      <linearGradient id="mb-bg" x1="1" y1="1" x2="39" y2="39" gradientUnits="userSpaceOnUse"><stop stopColor="#040c1e"/><stop offset="1" stopColor="#07122a"/></linearGradient>
                      <linearGradient id="mb-bd" x1="1" y1="1" x2="39" y2="39" gradientUnits="userSpaceOnUse"><stop stopColor="#6366f1" stopOpacity="0.65"/><stop offset="1" stopColor="#5de4ff" stopOpacity="0.3"/></linearGradient>
                      <linearGradient id="mb-l" x1="10" y1="31" x2="20" y2="8" gradientUnits="userSpaceOnUse"><stop stopColor="#6366f1"/><stop offset="1" stopColor="#5de4ff"/></linearGradient>
                      <linearGradient id="mb-r" x1="30" y1="31" x2="20" y2="8" gradientUnits="userSpaceOnUse"><stop stopColor="#8b5cf6"/><stop offset="1" stopColor="#5de4ff"/></linearGradient>
                      <radialGradient id="mb-core" cx="40%" cy="35%" r="60%"><stop offset="0%" stopColor="#a8f4ff"/><stop offset="100%" stopColor="#5de4ff"/></radialGradient>
                    </defs>
                  </svg>
                  <span>Aibotics</span>
                </Link>
