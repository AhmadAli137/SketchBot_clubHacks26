...
export default function HomePage() {
  return (
    <>
        ...
        <div className="container">
          <Reveal>
            <div className="section-header">
              ...
              <p className="body-lg">
                SketchBot translates PhD-level robotics knowledge — kinematics, computer vision, control theory — into
                hands-on activities matched to any age. No textbooks. No prior experience. Just a robot, a piece of paper,
                and an AI tutor that meets students where they are.
              </p>
            </div>
          </Reveal>
            ...
            {[
              {
                ...
                title: 'Physical robot first',
                body: 'SketchBot drives on paper and draws with a pen. Students see real motion, real coordinates, real physics — not a simulation.',
              },
              {
                icon: '🧠',
                color: 'card-icon-purple',
                title: 'AI tutor built in',
                body: 'A Claude-powered tutor guides every session — explaining concepts, answering questions, and adapting its language to the student\'s age group.',
              },
              {
                icon: '📐',
                color: 'card-icon-cyan',
                title: 'Three depths per concept',
                body: 'Every topic comes in Intuitive (touch & language), Structural (block code), and Precise (real Python/math) flavors. Students unlock depth through mastery.',
              },
            ].map((c) => (
      ...
      {/* ── How it works ────────────────────────────────────────────────── */}
      <section className="section" id="how" style={{ background: 'rgba(255,255,255,0.015)' }}>
        <div className="container">
              ...
              <div className="feature-text">
                ...
                <div className="steps">
                  {[
                    {
                      n: '01',
                      title: 'Student gives a prompt',
                      body: 'Type it, speak it, drag blocks, or write code — three interaction modes for three age groups.',
                    },
                    {
                      n: '02',
                      title: 'AI plans the path',
                      body: 'Claude converts the intent into a robot path, explaining each step as it goes.',
                    },
                    {
                      n: '03',
                      title: 'Robot draws it on paper',
                      body: 'The SketchBot drives across the canvas, pen down, and produces a physical artifact students keep.',
                    },
                    {
                      n: '04',
                      title: 'Tutor teaches the concept',
                      body: 'After every drawing the AI tutor surfaces the engineering concept behind it — and asks Socratic questions to deepen understanding.',
                    },
                  ].map((s) => (
            ...
            <Reveal delay={0.15}>
              <div className="feature-visual">
                <div style={{ position: 'relative', zIndex: 1, padding: '32px', width: '100%' }}>
                  {/* Animated drawing path illustration */}
                  <svg viewBox="0 0 320 240" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%' }}>
                    ...
                    {/* Drawn spiral path */}
                    <path
                      d="M 160 120 C 160 120 190 90 210 100 C 230 110 225 140 205 155 C 185 170 155 165 140 145 C 125 125 130 95 150 80 C 170 65 200 65 220 78"
                      stroke="url(#pathGrad)"
                      strokeWidth="2.5"
                      strokeLinecap="round"
                      fill="none"
            ...
            {[
              {
                ...
                color: 'card-icon-blue',
                title: 'Desktop App',
                body: 'The classroom computer runs robot sessions, camera vision, and the AI tutor locally. No cloud dependency for the live session — everything is fast and offline-capable.',
                tags: ['Electron', 'Local runtime', 'Camera vision', 'AI tutor'],
              },
              {
                icon: '📱',
                color: 'card-icon-purple',
                title: 'Camera Buddy',
                body: 'A phone or tablet on the same Wi-Fi network instantly becomes an overhead camera. Students scan a QR code and join the room — no pairing wizard.',
                tags: ['iOS + Android', 'Expo', 'Same-network', 'Live preview'],
              },
              {
                icon: '🌐',
                color: 'card-icon-cyan',
                title: 'This Website',
                body: 'Teacher accounts, classroom management, app downloads, release notes, and billing. Designed for the ten minutes before class starts, not for the session itself.',
                tags: ['Accounts', 'Downloads', 'Billing', 'Support'],
              },
            ].map((c) => (
              <div key={c.title} className="card">
                <div className={`card-icon ${c.color}`}>{c.icon}</div>
            ...
            {[
              {
                ...
                ages: 'Ages 6–10',
                body: 'Touch the canvas, describe what to draw in plain words, and watch the robot bring it to life. The AI tutor uses friendly metaphors — no math required.',
                tags: ['Language prompts', 'Simulator mode', 'Visual feedback'],
              },
              {
                emoji: '👧',
                title: 'Student builders',
                ages: 'Ages 11–14',
                body: 'Snap blocks together to build programs, adjust parameters, and see how the robot responds. Learn loops, coordinates, and path planning through direct experiment.',
                tags: ['Block editor', 'Waypoint editor', 'Concept library'],
              },
              {
                emoji: '🧑‍💻',
                title: 'Young engineers',
                ages: 'Ages 15+',
                body: 'Write real Python. Plot parametric curves, implement PID gains, study homography. The tutor can switch to formal math notation and pull no punches.',
        ...
        <div className="container">
          <Reveal>
            <div className="section-header">
              ...
              <p className="body-lg">
                Every concept is grounded in something the robot physically does. Abstract theory becomes visible, tangible, and memorable.
              </p>
            </div>
          </Reveal>
